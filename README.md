...
- Record and retrieve inputs in an open, memory-driven format.
- Create save states that you can retrieve and rewind to.
- Save replays directly to disk.

## Setup

1. Copy the plugin into your project's `Plugins/` folder.
2. Build the project from your IDE or through Unreal.
